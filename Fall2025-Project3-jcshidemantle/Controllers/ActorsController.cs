using Fall2025_Project3_jcshidemantle.Data;
using Fall2025_Project3_jcshidemantle.Models;
using Fall2025_Project3_jcshidemantle.Models.ViewModels;
...
namespace Fall2025_Project3_jcshidemantle.Controllers
{
    public class ActorsController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            string[] topics = ["opinions on movies previously acted in", "personal life", "politics", "work", "family", "their view on the meaning of life"];
